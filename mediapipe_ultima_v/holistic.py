...
def main(video_dir):
    ...
    for consta_3 in range(0,468):
        if consta_3 < 467:
            prueba_1.writelines('{Index};{x};{y};'.format(Index='Index',x='x',y='y'))
        if consta_3 ==467:
    ...
    for consta in range(0,33):
        if consta < 32:
            prueba_2.writelines('{Index};{x};{y};'.format(Index='Index',x='x',y='y'))
        if consta ==32:
            prueba_2.writelines('{Index};{x};{y}\n'.format(Index='Index',x='x',y='y'))
    ...
    for consta_2 in range(0,21):
        if consta_2 < 20:
            prueba_3.writelines('{Index};{x};{y};{Hand};'.format(Index='Index',x='x',y='y',Hand='Mano'))
        if consta_2 ==20:
            prueba_3.writelines('{Index};{x};{y};{Hand}\n'.format(Index='Index',x='x',y='y',Hand='Mano'))
