...
def draw_face_landmarks(image, landmarks, prueba,prueba_1,tiemp,frame_i):
    ...
    prueba_1.writelines('{frame},{nam},{Time},'.format(nam='Face',frame=frame_i,Time=tiemp,))
    ...
    for index, landmark in enumerate(landmarks.landmark):
        ...
        prueba_1.writelines('{cordx},{cordy},'.format(cordx='coordx'+str(index)+'_'+str(landmark_x), cordy='coordy'+str(index)+'_'+str(landmark_y),))
